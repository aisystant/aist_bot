...
def get_practice_prompts(lang: str) -> Dict[str, str]:
    ...
    prompts = {
        'ru': {
            ...
            'adapt_instruction': "Адаптируй и персонализируй всё под профиль стажера.",
        ...
        'en': {
            ...
            'adapt_instruction': "Adapt and personalize everything to the student's profile.",
            ...
            'format_instruction': "Respond STRICTLY in this format:\nINTRO: (2-4 sentences)\nTASK: (adapted task)\nWORK_PRODUCT: (work product)\nEXAMPLES: (examples, each on a new line starting with •)",
        ...
        'es': {
            ...
            'adapt_instruction': "Adapta y personaliza todo al perfil del estudiante.",
            ...
            'format_instruction': "Responde ESTRICTAMENTE en este formato:\nINTRO: (2-4 oraciones)\nTASK: (tarea adaptada)\nWORK_PRODUCT: (producto de trabajo)\nEXAMPLES: (ejemplos, cada uno en nueva línea comenzando con •)",
        ...
        'fr': {
            ...
            'adapt_instruction': "Adapte et personnalise tout au profil de l'étudiant.",
            ...
            'format_instruction': "Réponds STRICTEMENT dans ce format :\nINTRO: (2-4 phrases)\nTASK: (tâche adaptée)\nWORK_PRODUCT: (produit de travail)\nEXAMPLES: (exemples, chacun sur une nouvelle ligne commençant par •)",
        ...
        'zh': {
            ...
            'concept': "概念",
            'source_data': "源数据",
            'adapt_instruction': "根据学员的个人资料调整和个性化所有内容。",
            ...
            'format_instruction': '请严格按照以下格式回复：\nINTRO:（2-4句话）\nTASK:（改编后的任务）\nWORK_PRODUCT:（工作成果）\nEXAMPLES:（示例，每个新行以•开头）',
