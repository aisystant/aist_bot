...
TRANSLATIONS = {
    'ru': {
        ...
        # Feed engine messages
        'feed.profile_not_found': 'Профиль не найден. Пройдите /start для регистрации.',
        'feed.already_active': 'Лента уже активна! Используйте /feed для продолжения.',
        'feed.activated': 'Режим Лента активирован! Сейчас предложу темы на неделю.',
        'feed.topics_generation_failed': 'Не удалось сгенерировать темы. Попробуйте позже.',
        'feed.select_topics_prompt': 'Выберите темы для изучения на этой неделе:',
        'feed.start_feed_first': 'Сначала запустите /feed для получения предложений.',
        'feed.topics_already_selected': 'Темы на эту неделю уже выбраны.',
        'feed.topics_accepted': 'Отлично! Выбрано {count} тем. Начинаем!',
        'feed.no_active_week': 'Нет активной недели. Используйте /feed для старта.',
        'feed.select_topics_first': 'Сначала выберите темы на неделю.',
        'feed.week_completed': 'Неделя завершена. Используйте /feed для новой.',
        'feed.digest_completed_today': 'Сегодняшний дайджест уже завершён. До завтра!',
        'feed.continuing_digest': 'Продолжаем дайджест...',
        'feed.incomplete_digest': 'У вас есть незавершённый дайджест. Напишите фиксацию, чтобы продолжить.',
        'feed.no_topics_selected': 'Нет выбранных тем. Используйте /feed для выбора.',
        'feed.no_active_week_short': 'Нет активной недели.',
        'feed.start_digest_first': 'Сначала начните дайджест на сегодня.',
        'feed.digest_already_completed': 'Сегодняшний дайджест уже завершён.',
        'feed.fixation_saved': 'Фиксация сохранена! До завтра.',
        # Feed handler messages
        'feed.use_feed_to_start': 'Используйте /feed для запуска режима Лента.',
        'feed.error_loading': 'Произошла ошибка при загрузке Ленты. Попробуйте позже.',
        'feed.max_topics_hint': 'Максимум 3 темы. Снимите выбор с другой темы.',
        'feed.use_feed_for_topics': 'Сначала используйте /feed для получения тем.',
        'feed.enter_topics': 'Введите темы.',
        'feed.topics_not_recognized': 'Не удалось распознать темы. Введите названия тем или номера из списка.',
        'feed.question_failed': 'Не удалось обработать вопрос. Попробуйте позже.',
        'feed.error_loading_status': 'Произошла ошибка при загрузке статуса. Попробуйте позже.',
        'feed.fixation_prompt': 'Напишите краткую фиксацию: что вы поняли, какие мысли возникли, как это связано с вашей жизнью.',
        'feed.fixation_too_short': 'Напишите хотя бы пару предложений для фиксации.',
        'feed.topics_edit_intro': 'Введите через запятую или с новой строки',
        'feed.one_topic_hint': 'Одна тема раскрывается глубже с каждым днём.',
    ...
    'en': {
        ...
        # Feed engine messages
        'feed.profile_not_found': 'Profile not found. Use /start to register.',
        'feed.already_active': 'Feed is already active! Use /feed to continue.',
        'feed.activated': 'Feed mode activated! Let me suggest topics for the week.',
        'feed.topics_generation_failed': 'Failed to generate topics. Try again later.',
        'feed.select_topics_prompt': 'Select topics to study this week:',
        'feed.start_feed_first': 'First run /feed to get topic suggestions.',
        'feed.topics_already_selected': 'Topics for this week are already selected.',
        'feed.topics_accepted': 'Great! {count} topics selected. Let\'s begin!',
        'feed.no_active_week': 'No active week. Use /feed to start.',
        'feed.select_topics_first': 'First select topics for the week.',
        'feed.week_completed': 'Week completed. Use /feed for a new one.',
        'feed.digest_completed_today': 'Today\'s digest is already completed. See you tomorrow!',
        'feed.continuing_digest': 'Continuing digest...',
        'feed.incomplete_digest': 'You have an incomplete digest. Write a fixation to continue.',
        'feed.no_topics_selected': 'No topics selected. Use /feed to select.',
        'feed.no_active_week_short': 'No active week.',
        'feed.start_digest_first': 'First start today\'s digest.',
        'feed.digest_already_completed': 'Today\'s digest is already completed.',
        'feed.fixation_saved': 'Fixation saved! See you tomorrow.',
        # Feed handler messages
        'feed.use_feed_to_start': 'Use /feed to start Feed mode.',
        'feed.error_loading': 'Error loading Feed. Try again later.',
        'feed.max_topics_hint': 'Maximum 3 topics. Deselect another topic first.',
        'feed.use_feed_for_topics': 'First use /feed to get topics.',
        'feed.enter_topics': 'Enter topics.',
        'feed.topics_not_recognized': 'Could not recognize topics. Enter topic names or numbers from the list.',
        'feed.question_failed': 'Failed to process question. Try again later.',
        'feed.error_loading_status': 'Error loading status. Try again later.',
        'feed.fixation_prompt': 'Write a brief fixation: what you understood, what thoughts arose, how it relates to your life.',
        'feed.fixation_too_short': 'Write at least a couple of sentences for the fixation.',
        'feed.topics_edit_intro': 'Enter comma-separated or on new lines',
        'feed.one_topic_hint': 'One topic gets deeper with each day.',
    ...
    'es': {
        ...
        # Feed engine messages
        'feed.profile_not_found': 'Perfil no encontrado. Usa /start para registrarte.',
        'feed.already_active': '¡Feed ya está activo! Usa /feed para continuar.',
        'feed.activated': '¡Modo Feed activado! Te sugeriré temas para la semana.',
        'feed.topics_generation_failed': 'No se pudieron generar temas. Inténtalo más tarde.',
        'feed.select_topics_prompt': 'Selecciona temas para estudiar esta semana:',
        'feed.start_feed_first': 'Primero ejecuta /feed para obtener sugerencias de temas.',
        'feed.topics_already_selected': 'Los temas de esta semana ya están seleccionados.',
        'feed.topics_accepted': '¡Excelente! {count} temas seleccionados. ¡Comencemos!',
        'feed.no_active_week': 'No hay semana activa. Usa /feed para comenzar.',
        'feed.select_topics_first': 'Primero selecciona los temas de la semana.',
        'feed.week_completed': 'Semana completada. Usa /feed para una nueva.',
        'feed.digest_completed_today': '¡El resumen de hoy ya está completado! ¡Hasta mañana!',
        'feed.continuing_digest': 'Continuando resumen...',
        'feed.incomplete_digest': 'Tienes un resumen incompleto. Escribe una fijación para continuar.',
        'feed.no_topics_selected': 'No hay temas seleccionados. Usa /feed para seleccionar.',
        'feed.no_active_week_short': 'No hay semana activa.',
        'feed.start_digest_first': 'Primero comienza el resumen de hoy.',
        'feed.digest_already_completed': 'El resumen de hoy ya está completado.',
        'feed.fixation_saved': '¡Fijación guardada! ¡Hasta mañana!',
        # Feed handler messages
        'feed.use_feed_to_start': 'Usa /feed para iniciar el modo Feed.',
        'feed.error_loading': 'Error al cargar Feed. Inténtalo más tarde.',
        'feed.max_topics_hint': 'Máximo 3 temas. Deselecciona otro tema primero.',
        'feed.use_feed_for_topics': 'Primero usa /feed para obtener temas.',
        'feed.enter_topics': 'Ingresa los temas.',
        'feed.topics_not_recognized': 'No se pudieron reconocer los temas. Ingresa nombres de temas o números de la lista.',
        'feed.question_failed': 'No se pudo procesar la pregunta. Inténtalo más tarde.',
        'feed.error_loading_status': 'Error al cargar el estado. Inténtalo más tarde.',
        'feed.fixation_prompt': 'Escribe una breve fijación: qué entendiste, qué pensamientos surgieron, cómo se relaciona con tu vida.',
        'feed.fixation_too_short': 'Escribe al menos un par de oraciones para la fijación.',
        'feed.topics_edit_intro': 'Ingresa separados por comas o en líneas nuevas',
        'feed.one_topic_hint': 'Un tema se profundiza con cada día.',
