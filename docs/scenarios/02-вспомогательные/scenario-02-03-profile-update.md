# 02.03 Сценарий обновления профиля
...
**Ограничение:** Если пользователь уже начал проходить темы (`completed_topics` не пуст), изменить дату старта нельзя — это нарушит согласованность статистики. Вместо этого показывается предупреждение:
...
| 2026-02-03 | Добавлено ограничение: нельзя изменить дату старта марафона при наличии прогресса |
