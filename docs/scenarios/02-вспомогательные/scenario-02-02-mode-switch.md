...
Кнопка "📚 Марафон" ─────────────────► Проверка текущего статуса
                                      ...
                                      [📚 Продолжить обучение]  ← главная кнопка
                                      [📝 Обновить данные]
                                      [⏰ Напоминания]
                                      [🔄 Сбросить марафон]

Кнопка "Продолжить обучение" ────────► Запускает /learn
                                      (генерация следующей темы)
```
...
Кнопка `[📚 Продолжить обучение]` — главное действие после активации Марафона.

```
Пользователь → Кнопка "📚 Продолжить обучение"

Бот → Запускает /learn
      (генерация следующей темы Марафона)
```

**Callback:** `marathon_learn`
...
| 2026-01-22 | Добавлена кнопка «Продолжить обучение» при активации Марафона |
