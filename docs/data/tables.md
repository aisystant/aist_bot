...
| Дата | Изменение |
|------|-----------|
| 2026-06-10 | **Миграции 027-028 (WP-406 Ф6):** `user_milestones` (flat таблица has_p1..has_p9 BOOLEAN — факты пережитых пользовательских польз P1-P9, пишет event-процессор, читает Дорожник DP.SC.173) + `user_milestone_offers` (история офферов Дорожника, partial UNIQUE index WHERE response IS NULL OR response = 'ignored' — защита от дублирующихся активных офферов). |
