...
PHASE1_QUESTIONS = [
    {
        ...
        "text": (
            "📍 <b>Вопрос 1 из 4</b>\n\n"
            "Как вы ведёте учёт времени, вложенного в саморазвитие?\n"
            "Есть ли у вас регулярный ритм занятий?"
        ),
        "labels": {
            1: "Нет никакого учёта",
            2: "Иногда замечаю, но не фиксирую",
            3: "Веду еженедельно",
            4: "Фиксирую ежедневно",
            5: "Автоматически + есть артефакты",
        },
    },
    {
        "slot": "cp.iwe",
        "text": (
            "📍 <b>Вопрос 2 из 4</b>\n\n"
            "Используете ли вы единую рабочую среду для развития?\n"
            "(VS Code + Pack + Claude, протоколы ОРЗ или аналоги)"
        ),
        "labels": {
            1: "Нет, не слышал(а)",
            2: "Слышал(а), но не использую",
            3: "Использую базово",
            4: "Использую систематически",
            5: "Развиваю свою среду",
        },
    },
    {
        "slot": "cp.wld",
        "text": (
            ...
            "Что лежит в основе вашего выбора?"
        ),
        "labels": {
            1: "Интуитивно / как получится",
            2: "Пробую анализировать",
            3: "Опираюсь на мировоззрение",
            4: "Системный анализ + мировоззрение",
            5: "Передаю системное мышление другим",
        },
    },
    {
        "slot": "cp.int",
        "text": (
            "📍 <b>Вопрос 4 из 4</b>\n\n"
            "Можете привести пример, когда применяли системное мышление\n"
            "к реальной рабочей или жизненной ситуации?"
        ),
        "labels": {
            1: "Пока нет такого опыта",
            2: "Слышал(а) о системном мышлении",
            3: "Знаю базовые различения",
            4: "Делаю системный разбор ситуаций",
            5: "Формализую и передаю методы",
        },
    },
]
...
PHASE2_QUESTIONS = {
    ...
    "cp.iwe": {
        ...
        "text": (
            "🔍 <b>Уточняющий вопрос</b>\n\n"
            "Инициируете ли вы изменения сами — в работе, жизни, окружении?\n"
            "Не ждёте, а сами запускаете новое?"
        ),
        "labels": {
            1: "Обычно жду, когда сложится",
            2: "Иногда пробую",
            3: "Инициирую в своей зоне",
            4: "Регулярно запускаю изменения",
            5: "Создаю среду для изменений",
        },
    },
    "cp.wld": {
