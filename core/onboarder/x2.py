...
_TOPIC_TEXT = {
    ...
    "roles": (
        "<b>Тебе помогут сами, когда нужно</b>\n"
        "Не нужно самому разбираться, что делать дальше. По ходу работы система "
        "сама заметит, если ты застрял, подскажет следующий шаг и соберёт твоё "
        "личное рабочее окружение. Это подсказки внутри дела, а не отдельная "
        "проверка знаний."
    ),
    "norms": (
