        ...
        try:
            ...
            if user_id:
                try:
                    ...
                    pass
                # DAU: last_active_date обновляется из record_active_day() для
                # субстантивной активности, + touch_last_active_date для любого
                # запроса (lightweight UPDATE, не трогает счётчики).
                try:
