...
DAILY_TOPICS_LIMIT = 2   # норма: 2 темы в день (теория + практика)
MAX_TOPICS_PER_DAY = 4   # максимум: 4 темы в день (можно нагнать 1 день)
...
1) СИСТЕМА — это вещь (объект с элементами и связями), а НЕ процесс, метод или абстракция.
   ЗАПРЕЩЕНО: «система привычек», «система мышления», «система обучения», «система развития», «система целеполагания».
   КОРРЕКТНО: набор практик, метод обучения, процесс развития, подход к целеполаганию.
...
- ЗАПРЕЩЕНО: «система обучения», «система развития», «система привычек», «система мышления», «система целеполагания»
- КОРРЕКТНО: «метод обучения», «процесс развития», «набор практик», «подход к мышлению», «целеполагание»
