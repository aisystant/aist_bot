...
**Статус языков:**
- [x] Русский (ru) — основной
- [x] Английский (en) — реализован
- [x] Французский (fr) — реализован (январь 2026)
- [ ] Испанский (es) — запланирован
- [ ] Китайский (zh) — запланирован
...
3. Создать `i18n/fr/` с переводами (✅ выполнено)

4. Заменить все вызовы `get_message()` на `t()`

5. Удалить `locales.py`

**Проверка:**
- Бот работает на русском, английском и французском

---

## Неделя 6: Очистка bot.py (ПОДГОТОВИТЕЛЬНЫЙ ЭТАП)
...
1. Удалить неиспользуемый код из `engines/` (если остался)

2. Удалить `locales.py` (если ещё не удалён)
