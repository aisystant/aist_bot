...
async def migrate():
    ...
    try:
        ...
        await conn.execute("""
            INSERT INTO seminars (title, description, price_rub, price_stars, is_free, chat_id, video_url, duration, event_date, sort_order, tilda_uid) VALUES
            ...
            ('Инженерия всего на пороге',
             ...
             '2 дня', '2024-12-07', 2, 'EA-2024.1-T'),

            ('Интеллектуальная рабочая среда IWE для управляемого развития',
             'Среда для стабилизации процесса развития. Демонстрация работы с ИИ-планированием, фиксацией знаний и измерением времени',
             5000, 2500, FALSE, -1003674048529, 'https://t.me/c/3674048529/224',
             '3,5 часа', '2026-02-28', 10, 'SE-2026.2-T'),
            ...
            ('Архитектура разговора: моделирование как инструмент влияния',
             ...
             '2 часа', '2025-12-13', 11, 'SE-2025.4-T'),
            ...
            ('ИИ-агенты и экзокортекс: как делегировать рутину, не теряя мышление',
             ...
             '5 часов', '2025-11-15', 12, 'SE-2025.3-T'),
            ...
            ('First Principles Framework',
             ...
             '7 часов', '2025-10-04', 13, 'SE-2025.2-T'),
            ...
            ('First Principles Framework на пороге 2026',
             ...
             '4 часа', '2025-12-07', 14, 'FPF-2025.2'),
            ...
            ('Развитие для развитых в 2026',
             ...
             '7 часов', '2026-02-01', 15, 'SE-2026.1-T'),
            ...
            ('Мантры по организационному развитию',
             ...
             '7 часов', '2025-04-26', 16, 'LS-2025.1-T');
        """)
