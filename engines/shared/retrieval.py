...
TERM_RELATIONS: Dict[str, List[str]] = {
    ...
    # Системное мышление
    "система": ["системный подход", "элементы и связи", "функция системы", "надсистема", "системное мышление"],
    "системное мышление": ["системный подход", "холизм", "взаимосвязи", "эмерджентность", "система"],
    "мантра": ["мантра системного мышления", "принципы мышления", "чек-лист"],
    "экзокортекс": ["внешний мозг", "заметки", "база знаний", "second brain", "IWE"],
    "экзоскелет": ["протез", "усиление", "костюм Iron Man", "IWE", "расширитель"],
