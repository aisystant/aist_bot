...
3. Отвечай СТРОГО на основе предоставленного контекста. НЕ додумывай, НЕ дополняй, НЕ экстраполируй
4. Если в контексте нет полного ответа — перечисли что ЕСТЬ в материалах и скажи что на остальное не хватило памяти
